...
def update_employee():
    id = input("Enter the employee's id: ")
    if employee := Department.find_by_id(id):
        try:
...
def list_department_employees():
    ...
    depart_id = int(department_id)
    employees = Employee.get_all()
    
    for employee in employees:
        if employee.department_id == depart_id:
            print(employee)
        else:
            print("Error department id not found")
            return